...
from ..models import Post, PostRate, Profile, Follower
...
class PostSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Post
        fields = ['id', 'post_belongs_to_authenticated_user', 
                  'posted_by', 'pub_date', 'text', 'image', 
                  'in_reply_to_post', 'likes_count', 'dislikes_count', 
                  'comments_count']
